...
public class MusicFavAdapter extends BaseAdapter {
	...
	public MusicFavAdapter(Context context, ArrayList<MusicListBean> list) {
		...
		viewCache.imageBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (MainActivity.playList.getCurrent_focus() == MainActivity.FAVOURITE_TAG) {
					MainActivity.playList.setPlayList(list);
				}
				MusicFavAdapter.this.notifyDataSetChanged();
			}
		});
